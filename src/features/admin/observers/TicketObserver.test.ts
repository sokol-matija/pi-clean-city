    ...
    describe('TicketSubject', () => {
        ...
        describe('attach', () => {
            it('should add observer to observers list', () => {
                ...
                expect(consoleLogSpy).toHaveBeenCalledWith(
                    expect.stringContaining('Total observers: 1')
                )
            })
            ...
            it('should allow multiple different observers', () => {
                ...
                //ASSERT
                expect(consoleLogSpy).toHaveBeenCalledWith(
                    expect.stringContaining('Total observers: 2')
                )
            })
        })
        ...
        describe('detach', () => {
            it('should remove observer from observers list', () => {
                ...
                expect(consoleLogSpy).toHaveBeenCalledWith(
                    expect.stringContaining('Total observers: 0')
                )
            })
        ...
        describe('LoggerObserver', () => {
            ...
            it('should include ISO timestamp in the log', () => {
                ...
                const logCall = consoleLogSpy.mock.calls.find((call: any[]) =>
                    call[0].includes('[LoggerObserver]') && call[0]?.includes('Ticket')
                )
            ...
            it('should work with TicketSubject', () => {
                ...
                expect(consoleLogSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[LoggerObserver]')
                )
            })
        })
        ...
        describe('Observer Pattern Integration', () => {
            it('should work with multiple observer types together', () => {
                ...
                // UI observer logirao
                expect(consoleLogSpy).toHaveBeenCalledWith(
                    expect.stringContaining('[UIRefreshObserver]')
                )
            })
        })
    })
